$(document).ready(function(){
	...
	$('#bot').css('box-shadow', randomShadow)
	...
	var leftpompom = ['*'] 
	var randomLeftPompom = leftpompom[Math.floor(Math.random()*leftpompom.length)]
	$('#leftpompom').text(randomLeftPompom)

	var rightpompom = ['*'] 
	var randomRightPompom = rightpompom[Math.floor(Math.random()*rightpompom.length)]
	$('#rightpompom').text(randomRightPompom)

	var leftColorArray = ['midnightblue', 'royalblue', 'cornflowerblue', 'powderblue', 'cadetblue', 'teal', 'darkseagreen', 'darkkhaki', 'lightcoral', 'thistle', 'lavender', 'mistyrose', 'rosybrown', 'plum', 'orchid', 'maroon', 'mediumpurple', 'darkmagenta', 'mediumslateblue', 'slateblue']
	var randomLeftColor = leftColorArray[Math.floor(Math.random()*leftColorArray.length)]
	$('#leftpompom').css('color', randomLeftColor)

	var rightColorArray = ['midnightblue', 'royalblue', 'cornflowerblue', 'powderblue', 'cadetblue', 'teal', 'darkseagreen', 'darkkhaki', 'lightcoral', 'thistle', 'lavender', 'mistyrose', 'rosybrown', 'plum', 'orchid', 'maroon', 'mediumpurple', 'darkmagenta', 'mediumslateblue', 'slateblue']
	var randomRightColor = rightColorArray[Math.floor(Math.random()*rightColorArray.length)]
	$('#rightpompom').css('color', randomRightColor)
})